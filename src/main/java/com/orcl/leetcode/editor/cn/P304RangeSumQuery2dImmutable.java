...
// 
// Related Topics 设计 数组 矩阵 前缀和 👍 352 👎 0

package com.orcl.leetcode.editor.cn;

/**
 * @description: 二维区域和检索 - 矩阵不可变
 * @date: 2022-03-08 10:19:50
 * @author: orcl
 */
public class P304RangeSumQuery2dImmutable {
    public static void main(String[] args) {
        NumMatrix solution = new P304RangeSumQuery2dImmutable().new NumMatrix(new int[][]{
                {3, 0, 1, 4, 2},
                {5, 6, 3, 2, 1},
                {1, 2, 0, 1, 5},
                {4, 1, 0, 1, 7},
        ...
        int sum = solution.sumRegion(2, 1, 4, 3);
